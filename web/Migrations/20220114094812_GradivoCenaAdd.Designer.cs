...
namespace web.Migrations
{
    ...
    [Migration("20220114094812_GradivoCenaAdd")]
    partial class GradivoCenaAdd
    {
            ...
            modelBuilder.Entity("web.Models.Gradivo", b =>
                {
                    ...
                    b.Property<decimal>("CenaGradivo")
            ...
            modelBuilder.Entity("web.Models.GradivoIzvod", b =>
                {
                    ...
                    b.HasIndex("IzposojaID")
                        .IsUnique()
                        .HasFilter("[IzposojaID] IS NOT NULL");

                    b.HasIndex("NakupID")
                        .IsUnique()
                        .HasFilter("[NakupID] IS NOT NULL");
            ...
            modelBuilder.Entity("web.Models.Izposoja", b =>
                {
                    ...
                    b.Property<int>("IdIzposojenegaGradiva")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("web.Models.Nakup", b =>
                {
                    ...
                    b.Property<int>("IdKupljenegaGradiva")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("web.Models.GradivoIzvod", b =>
                {
                    ...
                    b.HasOne("web.Models.Izposoja", "Izposoja")
                        .WithOne("GradivoIzvod")
                        .HasForeignKey("web.Models.GradivoIzvod", "IzposojaID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("web.Models.Nakup", "Nakup")
                        .WithOne("GradivoIzvod")
                        .HasForeignKey("web.Models.GradivoIzvod", "NakupID")
                        .OnDelete(DeleteBehavior.Restrict);
